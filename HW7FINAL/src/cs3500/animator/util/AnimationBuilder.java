...
/**
 * Class to build an instance of a model. Has methods to set the bounds of the canvas, declare
 * shapes in the model, and add motions to shapes.
 *
 * @param <Doc> an instance of the model
 */
