...
public class AnimationReader {
   ...
   * See {@link cs3500.animator.util.AnimationBuilder#addMotion}</li>
   * </ul>
   * </p>
   *
  ...
  public static <Doc> Doc parseFile(Readable readable,
      cs3500.animator.util.AnimationBuilder<Doc> builder) {
  ...
  private static <Doc> void readCanvas(Scanner s,
      cs3500.animator.util.AnimationBuilder<Doc> builder) {
    int[] vals = new int[4];
  ...
  private static <Doc> void readShape(Scanner s,
      cs3500.animator.util.AnimationBuilder<Doc> builder) {
    String name;
    String type;
    if (s.hasNext()) {
